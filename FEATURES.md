...
- **Add recipients by viewer tag** _(admin, single and bulk share forms)_ — if any approved viewers carry tags (see People & oversight below), the share form shows a "Add viewers by tag" picker that appends every viewer with that tag straight into the recipients field, instead of pasting emails by hand.
