...
- **An admin is locked out by `ADMIN_GEO_WHITELIST`** — edit the env var directly in Vercel (add the admin's current country) and redeploy; this doesn't depend on `/admin` being reachable.
