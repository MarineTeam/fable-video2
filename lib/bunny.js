...
// bunny's own video object, never to the `chapters` hash — the hand-typed list
...
// textarea, where a person accepts it through the ordinary /api/admin/chapters
// save. That is the "explicit accept action" this comment used to call unbuilt.
//
...
export function transcribeVideo(id, { sourceLanguage, force = false, generateChapters = false } = {}) {
