...
import { isShareActive, revokeShare, loadShares, ttlSecondsFor } from './share';
...
// Track a newly created share as this video's invite for `email`. The hash's
// own TTL only needs to cover its longest-lived tracked entry, so it's
// re-derived and extended forward (never shrunk) on every write — same
