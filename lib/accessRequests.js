...
// Free text typed by a signed-in stranger, so it is clamped AND stripped here
// at the single point of entry rather than at each place it is later shown.
// Whitespace collapsing already removed newlines and tabs; this also drops the
// remaining C0/C1 control characters and the zero-width joiners that survive a
// trim and can corrupt a notification body or a terminal reading the audit log.
// Escaping for HTML still happens at the render site — this is not a substitute
// for it.
